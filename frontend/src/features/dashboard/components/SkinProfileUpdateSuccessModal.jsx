...
const SkinProfileUpdateSuccessModal = (props) => {
  const { isMobile } = useDeviceDetect();
  return (
    <CustomModal onClose={props.onClose}>
      <SuccessModalContainer>
        <SuccessMessage>
          Thanks for updating your Skin Profile.
        </SuccessMessage>
        <SuccessSubtext>
          You’re all set for the year! Your provider will evaluate your updated information for your upcoming order.
        </SuccessSubtext>
...
export default SkinProfileUpdateSuccessModal;
